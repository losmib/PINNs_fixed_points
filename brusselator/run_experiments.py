...
from model.plots import learning_curves, brusselator_example_dynamics, loss_over_tcoll, plot_regularization
import pandas as pd
import numpy as np
import os
import re
...
for params in grid_parameters(param_grid):
    ...
    for i in range(NUM_TRAINING_RUNS):
        ...
        brusselator_example_dynamics(PINN, path=f"logs/{dirname}/run_{i}/dynamics")
    ...
    pd.concat(results_list).to_csv("results_reg_stability_10.csv")
