...
class DataLoader():
    ...
    args = ['seed', 'alpha', 'beta', 'delta', 'gamma', 'omega', 'T',
            'x0', 'x_t0', 'N_col']
    ...
    def diff_equations(self, t, y):
        ...
        '''  
        x, x_t = y[0], y[1]
        return np.array([x_t, -self.delta * x_t - self.alpha * x - self.beta * x**3 + self.gamma * tf.cos(self.omega * t)]) 
    ...
    def reference(self, N_eval=None):
        ...
        x_t = self.array2tensor(results.y[1])
        return t_line, x, x_t